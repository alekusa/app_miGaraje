...
import './models/talleresModel.dart';
...
class TalleresMap extends StatefulWidget {
  @override
  _TalleresMapState createState() => _TalleresMapState();
}

class _TalleresMapState extends State<TalleresMap> {
